...
# build directory.
TCL_BUILD_LIB_SPEC='-L/mnt/aos/sources/tcl8.5.13/unix -ltcl8.5'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/tools/lib -ltcl8.5'
...
# compiled.
TCL_SRC_DIR='/mnt/aos/sources/tcl8.5.13'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/mnt/aos/sources/tcl8.5.13/unix -ltclstub8.5'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/tools/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/mnt/aos/sources/tcl8.5.13/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/tools/lib/libtclstub8.5.a'
